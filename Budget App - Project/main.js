...
class Budget {
    ...
    constructor() {
        // Properties (State)
        this.budgetInput = document.getElementById("budget-value"); // Get the Budget of the User
    ...
    loadUserData() {
        if (this.savedBudget) {
            ...
            this.drawExpenses(); // Re-draw all the expenses
        } else {
    ...
    removeExpense(i) {
        ...
        this.drawExpenses(); // Re-draw all expenses
